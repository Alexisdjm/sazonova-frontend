import { InstagramIcon, TikTokIcon, GarlicIcon, OnionIcon, SazonovaLettersIcon } from './icons';

const Footer = () => {
  return (
    <footer className="h-screen bg-primary-red w-full py-10 relative overflow-hidden font-ubuntu">
      {/* Absolute Background Icons */}
      <div className="absolute w-full flex flex-row justify-between right-0 bottom-0 opacity-10 pointer-events-nonetranslate-y-1/4 translate-x-12">
        <OnionIcon className="w-80 h-80 md:w-[600px] md:h-[600px] -mr-32" color="var(--secondary-beige)" />
        <GarlicIcon className="w-80 h-80 md:w-[600px] md:h-[600px]" color="var(--secondary-beige)" />
      </div>

      <div className="mx-auto flex flex-col px-10 md:px-20 relative z-10">

        {/* Top Header */}
        <div className="w-full flex flex-col md:flex-row justify-between items-center pb-6 border-b border-secondary-beige/30">
        ...
        {/* Links Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 py-16 text-secondary-beige">
          {/* Column 1 */}
        ...
        {/* Footer Bottom */}
        <div className="pt-6 pb-2 border-t border-secondary-beige/30 text-center">
          <p className="text-secondary-beige text-xs font-light">2026 Sazonova. All rights reserved</p>
        </div>
