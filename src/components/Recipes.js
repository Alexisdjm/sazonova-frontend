  ...
  return (
    <>
      <div className="relative w-full bg-[#650208] bg-fixed overflow-hidden">
        ...
        <div className="relative z-10 w-full md:w-[80%] max-w-10xl md:ml-5 mx-auto px-2 sm:px-7">
          <Carousel
          ...
          >
            {recipes.length > 0 ? (
              ...
              <RecipeCard
                ...
                description="6 ingredientes - 50min"
                time="15 min"
              />
            )}
          </Carousel>
        ...
        <div className="w-fit mx-auto my-10 relative z-10">
          <Link to="/recipes" className="inline-block">
            <AnimatedButton styleKind="style3" className="cursor-pointer">
              Ver Recetas
            </AnimatedButton>
          </Link>
        </div>
        ...
        <OnionThreeIcon
          ...
          width={400}
          height={400}
          className="rotate-12 absolute z-[0] top-[2em] right-[25%] lg:right-0"
        />
        <GarlicTwoIcon
          color="#78030A"
          width={400}
          height={400}
          className="rotate-[-12deg] absolute z-[0] bottom-[-7%] left-[25%] lg:left-0"
        />
        <img
          width={250}
          height={250}
          src={images.cuchara}
          alt="cuchara"
          className="rotate-[-90deg] absolute z-[0] -top-[2.5em] left-20"
        />
        <BrandSpin
          width={70}
          height={70}
          className="absolute z-[0] bottom-10 left-10 opacity-80"
        />
      </div>
    </>
  );
